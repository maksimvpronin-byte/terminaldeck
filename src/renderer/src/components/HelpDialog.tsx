...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { what: 'The desktop follows the screen’s own pixels, so a Retina display does not blur it' },
      { what: 'Past the pixel budget it asks for a size between the pane and the screen' },
